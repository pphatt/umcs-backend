...
namespace Server.Infrastructure.Migrations
{
    ...
    [Migration("20250326091600_ChangeSomeFieldsNameInPrivateChatMessageTable")]
    partial class ChangeSomeFieldsNameInPrivateChatMessageTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Domain.Entity.Content.ContributionPublicBookmark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ContributionPublicBookmarks");
                });
            ...
            modelBuilder.Entity("Server.Domain.Entity.Content.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Domain.Entity.Content.NotificationUser", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Domain.Entity.Content.PrivateChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Domain.Entity.Content.PrivateChatRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Domain.Entity.Content.ContributionPublicBookmark", b =>
                {
                    b.HasOne("Server.Domain.Entity.Content.ContributionPublic", "ContributionPublic")
                        .WithMany("Bookmarks")
                        .HasForeignKey("ContributionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ContributionPublic");
            ...
            modelBuilder.Entity("Server.Domain.Entity.Content.Notification", b =>
                {
                    b.HasOne("Server.Domain.Entity.Identity.AppUser", "Sender")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Server.Domain.Entity.Content.NotificationUser", b =>
                {
                    b.HasOne("Server.Domain.Entity.Content.Notification", "Notification")
